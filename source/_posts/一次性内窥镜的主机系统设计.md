...
$$ u(s)=\left\{ \begin{matrix}
  ...
  {A_1}{|s|^3}+{B_1}{|s|^2}+{C_1}{|s|}+{D_1} & 0<|s|<1 \\

  {A_2}{|s|^3}+{B_2}{|s|^2}+{C_2}{|s|}+{D_2} & 1<|s|<2 \\

  0 & 2<{|s|} \\

\end{matrix} \right. $$

$$ u(s)=\left\{ \begin{matrix}{A_1}{|s|^3}+{B_1}{|s|^2}+{C_1}{|s|}+{D_1} & 0<|s|<1 \\{A_2}{|s|^3}+{B_2}{|s|^2}+{C_2}{|s|}+{D_2} & 1<|s|<2 \\0 & 2<{|s|} \\\end{matrix} \right. $$
